...
#define MMA_INST(_d0, _d1, _d2, _d3, _a0, _a1, _b0, _b1) \
        asm volatile(MMA_INST_OPCODE:   "=r"(_d0), "=r"(_d1), "=r"(_d2), "=r"(_d3): \
                     "r"(_a0), "r"(_a1), "r"(_b0),  "r"(_b1),  "r"(_d0),  "r"(_d1), "r"(_d2), "r"(_d3));

#define MMA_INST_ASCEND1(_C, _C_off, _C_stride, _a, _B) \
        { \
            MMA_INST(_C[_C_off],                 _C[_C_off + 1],                 _C[_C_off + 2],                 _C[_C_off + 3],                 _a.x, _a.y, _B[0].x, _B[0].y); \
            MMA_INST(_C[_C_off],                 _C[_C_off + 1],                 _C[_C_off + 2],                 _C[_C_off + 3],                 _a.z, _a.w, _B[0].z, _B[0].w); \
        }

#define MMA_INST_ASCEND2(_C, _C_off, _C_stride, _a, _B) \
        { \
            MMA_INST(_C[_C_off],                 _C[_C_off + 1],                 _C[_C_off + 2],                 _C[_C_off + 3],                 _a.x, _a.y, _B[0].x, _B[0].y); \
            MMA_INST(_C[_C_off],                 _C[_C_off + 1],                 _C[_C_off + 2],                 _C[_C_off + 3],                 _a.z, _a.w, _B[0].z, _B[0].w); \
            MMA_INST(_C[_C_off + _C_stride],     _C[_C_off + 1 + _C_stride],     _C[_C_off + 2 + _C_stride],     _C[_C_off + 3 + _C_stride],     _a.x, _a.y, _B[1].x, _B[1].y); \
            MMA_INST(_C[_C_off + _C_stride],     _C[_C_off + 1 + _C_stride],     _C[_C_off + 2 + _C_stride],     _C[_C_off + 3 + _C_stride],     _a.z, _a.w, _B[1].z, _B[1].w); \
        }
        
#define MMA_INST_ASCEND4(_C, _C_off, _C_stride, _a, _B) \
        { \
            MMA_INST(_C[_C_off],                 _C[_C_off + 1],                 _C[_C_off + 2],                 _C[_C_off + 3],                 _a.x, _a.y, _B[0].x, _B[0].y); \
            MMA_INST(_C[_C_off + _C_stride],     _C[_C_off + 1 + _C_stride],     _C[_C_off + 2 + _C_stride],     _C[_C_off + 3 + _C_stride],     _a.x, _a.y, _B[1].x, _B[1].y); \
            MMA_INST(_C[_C_off + _C_stride * 2], _C[_C_off + 1 + _C_stride * 2], _C[_C_off + 2 + _C_stride * 2], _C[_C_off + 3 + _C_stride * 2], _a.x, _a.y, _B[2].x, _B[2].y); \
            MMA_INST(_C[_C_off + _C_stride * 3], _C[_C_off + 1 + _C_stride * 3], _C[_C_off + 2 + _C_stride * 3], _C[_C_off + 3 + _C_stride * 3], _a.x, _a.y, _B[3].x, _B[3].y); \
            MMA_INST(_C[_C_off],                 _C[_C_off + 1],                 _C[_C_off + 2],                 _C[_C_off + 3],                 _a.z, _a.w, _B[0].z, _B[0].w); \
            MMA_INST(_C[_C_off + _C_stride],     _C[_C_off + 1 + _C_stride],     _C[_C_off + 2 + _C_stride],     _C[_C_off + 3 + _C_stride],     _a.z, _a.w, _B[1].z, _B[1].w); \
            MMA_INST(_C[_C_off + _C_stride * 2], _C[_C_off + 1 + _C_stride * 2], _C[_C_off + 2 + _C_stride * 2], _C[_C_off + 3 + _C_stride * 2], _a.z, _a.w, _B[2].z, _B[2].w); \
            MMA_INST(_C[_C_off + _C_stride * 3], _C[_C_off + 1 + _C_stride * 3], _C[_C_off + 2 + _C_stride * 3], _C[_C_off + 3 + _C_stride * 3], _a.z, _a.w, _B[3].z, _B[3].w); \
        }
        
#define MMA_INST_ASCEND8(_C, _C_off, _C_stride, _a, _B) \
        { \
            MMA_INST(_C[_C_off],                 _C[_C_off + 1],                 _C[_C_off + 2],                 _C[_C_off + 3],                 _a.x, _a.y, _B[0].x, _B[0].y); \
            MMA_INST(_C[_C_off + _C_stride],     _C[_C_off + 1 + _C_stride],     _C[_C_off + 2 + _C_stride],     _C[_C_off + 3 + _C_stride],     _a.x, _a.y, _B[1].x, _B[1].y); \
            MMA_INST(_C[_C_off + _C_stride * 2], _C[_C_off + 1 + _C_stride * 2], _C[_C_off + 2 + _C_stride * 2], _C[_C_off + 3 + _C_stride * 2], _a.x, _a.y, _B[2].x, _B[2].y); \
            MMA_INST(_C[_C_off + _C_stride * 3], _C[_C_off + 1 + _C_stride * 3], _C[_C_off + 2 + _C_stride * 3], _C[_C_off + 3 + _C_stride * 3], _a.x, _a.y, _B[3].x, _B[3].y); \
            MMA_INST(_C[_C_off + _C_stride * 4], _C[_C_off + 1 + _C_stride * 4], _C[_C_off + 2 + _C_stride * 4], _C[_C_off + 3 + _C_stride * 4], _a.x, _a.y, _B[4].x, _B[4].y); \
            MMA_INST(_C[_C_off + _C_stride * 5], _C[_C_off + 1 + _C_stride * 5], _C[_C_off + 2 + _C_stride * 5], _C[_C_off + 3 + _C_stride * 5], _a.x, _a.y, _B[5].x, _B[5].y); \
            MMA_INST(_C[_C_off + _C_stride * 6], _C[_C_off + 1 + _C_stride * 6], _C[_C_off + 2 + _C_stride * 6], _C[_C_off + 3 + _C_stride * 6], _a.x, _a.y, _B[6].x, _B[6].y); \
            MMA_INST(_C[_C_off + _C_stride * 7], _C[_C_off + 1 + _C_stride * 7], _C[_C_off + 2 + _C_stride * 7], _C[_C_off + 3 + _C_stride * 7], _a.x, _a.y, _B[7].x, _B[7].y); \
            MMA_INST(_C[_C_off],                 _C[_C_off + 1],                 _C[_C_off + 2],                 _C[_C_off + 3],                 _a.z, _a.w, _B[0].z, _B[0].w); \
            MMA_INST(_C[_C_off + _C_stride],     _C[_C_off + 1 + _C_stride],     _C[_C_off + 2 + _C_stride],     _C[_C_off + 3 + _C_stride],     _a.z, _a.w, _B[1].z, _B[1].w); \
            MMA_INST(_C[_C_off + _C_stride * 2], _C[_C_off + 1 + _C_stride * 2], _C[_C_off + 2 + _C_stride * 2], _C[_C_off + 3 + _C_stride * 2], _a.z, _a.w, _B[2].z, _B[2].w); \
            MMA_INST(_C[_C_off + _C_stride * 3], _C[_C_off + 1 + _C_stride * 3], _C[_C_off + 2 + _C_stride * 3], _C[_C_off + 3 + _C_stride * 3], _a.z, _a.w, _B[3].z, _B[3].w); \
            MMA_INST(_C[_C_off + _C_stride * 4], _C[_C_off + 1 + _C_stride * 4], _C[_C_off + 2 + _C_stride * 4], _C[_C_off + 3 + _C_stride * 4], _a.z, _a.w, _B[4].z, _B[4].w); \
            MMA_INST(_C[_C_off + _C_stride * 5], _C[_C_off + 1 + _C_stride * 5], _C[_C_off + 2 + _C_stride * 5], _C[_C_off + 3 + _C_stride * 5], _a.z, _a.w, _B[5].z, _B[5].w); \
            MMA_INST(_C[_C_off + _C_stride * 6], _C[_C_off + 1 + _C_stride * 6], _C[_C_off + 2 + _C_stride * 6], _C[_C_off + 3 + _C_stride * 6], _a.z, _a.w, _B[6].z, _B[6].w); \
            MMA_INST(_C[_C_off + _C_stride * 7], _C[_C_off + 1 + _C_stride * 7], _C[_C_off + 2 + _C_stride * 7], _C[_C_off + 3 + _C_stride * 7], _a.z, _a.w, _B[7].z, _B[7].w); \
        }

#define MMA_INST_DESCEND1(_C, _C_off, _C_stride, _a, _B) \
        { \
            MMA_INST(_C[_C_off],                 _C[_C_off + 1],                 _C[_C_off + 2],                 _C[_C_off + 3],                 _a.x, _a.y, _B[0].x, _B[0].y); \
            MMA_INST(_C[_C_off],                 _C[_C_off + 1],                 _C[_C_off + 2],                 _C[_C_off + 3],                 _a.z, _a.w, _B[0].z, _B[0].w); \
        }

#define MMA_INST_DESCEND2(_C, _C_off, _C_stride, _a, _B) \
        { \
            MMA_INST(_C[_C_off],                 _C[_C_off + 1],                 _C[_C_off + 2],                 _C[_C_off + 3],                 _a.x, _a.y, _B[1].x, _B[1].y); \
            MMA_INST(_C[_C_off - _C_stride],     _C[_C_off + 1 - _C_stride],     _C[_C_off + 2 - _C_stride],     _C[_C_off + 3 - _C_stride],     _a.x, _a.y, _B[0].x, _B[0].y); \
            MMA_INST(_C[_C_off],                 _C[_C_off + 1],                 _C[_C_off + 2],                 _C[_C_off + 3],                 _a.z, _a.w, _B[1].z, _B[1].w); \
            MMA_INST(_C[_C_off - _C_stride],     _C[_C_off + 1 - _C_stride],     _C[_C_off + 2 - _C_stride],     _C[_C_off + 3 - _C_stride],     _a.z, _a.w, _B[0].z, _B[0].w); \
        }
        
#define MMA_INST_DESCEND4(_C, _C_off, _C_stride, _a, _B) \
        { \
            MMA_INST(_C[_C_off],                 _C[_C_off + 1],                 _C[_C_off + 2],                 _C[_C_off + 3],                 _a.x, _a.y, _B[3].x, _B[3].y); \
            MMA_INST(_C[_C_off - _C_stride],     _C[_C_off + 1 - _C_stride],     _C[_C_off + 2 - _C_stride],     _C[_C_off + 3 - _C_stride],     _a.x, _a.y, _B[2].x, _B[2].y); \
            MMA_INST(_C[_C_off - _C_stride * 2], _C[_C_off + 1 - _C_stride * 2], _C[_C_off + 2 - _C_stride * 2], _C[_C_off + 3 - _C_stride * 2], _a.x, _a.y, _B[1].x, _B[1].y); \
            MMA_INST(_C[_C_off - _C_stride * 3], _C[_C_off + 1 - _C_stride * 3], _C[_C_off + 2 - _C_stride * 3], _C[_C_off + 3 - _C_stride * 3], _a.x, _a.y, _B[0].x, _B[0].y); \
            MMA_INST(_C[_C_off],                 _C[_C_off + 1],                 _C[_C_off + 2],                 _C[_C_off + 3],                 _a.z, _a.w, _B[3].z, _B[3].w); \
            MMA_INST(_C[_C_off - _C_stride],     _C[_C_off + 1 - _C_stride],     _C[_C_off + 2 - _C_stride],     _C[_C_off + 3 - _C_stride],     _a.z, _a.w, _B[2].z, _B[2].w); \
            MMA_INST(_C[_C_off - _C_stride * 2], _C[_C_off + 1 - _C_stride * 2], _C[_C_off + 2 - _C_stride * 2], _C[_C_off + 3 - _C_stride * 2], _a.z, _a.w, _B[1].z, _B[1].w); \
            MMA_INST(_C[_C_off - _C_stride * 3], _C[_C_off + 1 - _C_stride * 3], _C[_C_off + 2 - _C_stride * 3], _C[_C_off + 3 - _C_stride * 3], _a.z, _a.w, _B[0].z, _B[0].w); \
        }

#define MMA_INST_DESCEND8(_C, _C_off, _C_stride, _a, _B) \
        { \
            MMA_INST(_C[_C_off],                 _C[_C_off + 1],                 _C[_C_off + 2],                 _C[_C_off + 3],                 _a.x, _a.y, _B[7].x, _B[7].y); \
            MMA_INST(_C[_C_off - _C_stride],     _C[_C_off + 1 - _C_stride],     _C[_C_off + 2 - _C_stride],     _C[_C_off + 3 - _C_stride],     _a.x, _a.y, _B[6].x, _B[6].y); \
            MMA_INST(_C[_C_off - _C_stride * 2], _C[_C_off + 1 - _C_stride * 2], _C[_C_off + 2 - _C_stride * 2], _C[_C_off + 3 - _C_stride * 2], _a.x, _a.y, _B[5].x, _B[5].y); \
            MMA_INST(_C[_C_off - _C_stride * 3], _C[_C_off + 1 - _C_stride * 3], _C[_C_off + 2 - _C_stride * 3], _C[_C_off + 3 - _C_stride * 3], _a.x, _a.y, _B[4].x, _B[4].y); \
            MMA_INST(_C[_C_off - _C_stride * 4], _C[_C_off + 1 - _C_stride * 4], _C[_C_off + 2 - _C_stride * 4], _C[_C_off + 3 - _C_stride * 4], _a.x, _a.y, _B[3].x, _B[3].y); \
            MMA_INST(_C[_C_off - _C_stride * 5], _C[_C_off + 1 - _C_stride * 5], _C[_C_off + 2 - _C_stride * 5], _C[_C_off + 3 - _C_stride * 5], _a.x, _a.y, _B[2].x, _B[2].y); \
            MMA_INST(_C[_C_off - _C_stride * 6], _C[_C_off + 1 - _C_stride * 6], _C[_C_off + 2 - _C_stride * 6], _C[_C_off + 3 - _C_stride * 6], _a.x, _a.y, _B[1].x, _B[1].y); \
            MMA_INST(_C[_C_off - _C_stride * 7], _C[_C_off + 1 - _C_stride * 7], _C[_C_off + 2 - _C_stride * 7], _C[_C_off + 3 - _C_stride * 7], _a.x, _a.y, _B[0].x, _B[0].y); \
            MMA_INST(_C[_C_off],                 _C[_C_off + 1],                 _C[_C_off + 2],                 _C[_C_off + 3],                 _a.z, _a.w, _B[7].z, _B[7].w); \
            MMA_INST(_C[_C_off - _C_stride],     _C[_C_off + 1 - _C_stride],     _C[_C_off + 2 - _C_stride],     _C[_C_off + 3 - _C_stride],     _a.z, _a.w, _B[6].z, _B[6].w); \
            MMA_INST(_C[_C_off - _C_stride * 2], _C[_C_off + 1 - _C_stride * 2], _C[_C_off + 2 - _C_stride * 2], _C[_C_off + 3 - _C_stride * 2], _a.z, _a.w, _B[5].z, _B[5].w); \
            MMA_INST(_C[_C_off - _C_stride * 3], _C[_C_off + 1 - _C_stride * 3], _C[_C_off + 2 - _C_stride * 3], _C[_C_off + 3 - _C_stride * 3], _a.z, _a.w, _B[4].z, _B[4].w); \
            MMA_INST(_C[_C_off - _C_stride * 4], _C[_C_off + 1 - _C_stride * 4], _C[_C_off + 2 - _C_stride * 4], _C[_C_off + 3 - _C_stride * 4], _a.z, _a.w, _B[3].z, _B[3].w); \
            MMA_INST(_C[_C_off - _C_stride * 5], _C[_C_off + 1 - _C_stride * 5], _C[_C_off + 2 - _C_stride * 5], _C[_C_off + 3 - _C_stride * 5], _a.z, _a.w, _B[2].z, _B[2].w); \
            MMA_INST(_C[_C_off - _C_stride * 6], _C[_C_off + 1 - _C_stride * 6], _C[_C_off + 2 - _C_stride * 6], _C[_C_off + 3 - _C_stride * 6], _a.z, _a.w, _B[1].z, _B[1].w); \
            MMA_INST(_C[_C_off - _C_stride * 7], _C[_C_off + 1 - _C_stride * 7], _C[_C_off + 2 - _C_stride * 7], _C[_C_off + 3 - _C_stride * 7], _a.z, _a.w, _B[0].z, _B[0].w); \
        }

#define MMA_INST_1x1(_C, _A, _B) \
        { \
            MMA_INST_ASCEND1  (_C, 0,   4, _A[0], _B); \
        }

#define MMA_INST_1x2(_C, _A, _B) \
        { \
            MMA_INST_ASCEND2  (_C, 0,   4, _A[0], _B); \
        }

#define MMA_INST_1x4(_C, _A, _B) \
        { \
            MMA_INST_ASCEND4  (_C, 0,   4, _A[0], _B); \
        }

#define MMA_INST_1x8(_C, _A, _B) \
        { \
            MMA_INST_ASCEND8  (_C, 0,   4, _A[0], _B); \
        }

#define MMA_INST_2x1(_C, _A, _B) \
        { \
            MMA_INST_ASCEND1  (_C, 0,   4, _A[0], _B); \
            MMA_INST_DESCEND1 (_C, 4,   4, _A[1], _B); \
        }

#define MMA_INST_2x2(_C, _A, _B) \
        { \
            MMA_INST_ASCEND2  (_C, 0,   4, _A[0], _B); \
            MMA_INST_DESCEND2 (_C, 12,  4, _A[1], _B); \
        }

#define MMA_INST_2x4(_C, _A, _B) \
        { \
            MMA_INST_ASCEND4  (_C, 0,   4, _A[0], _B); \
            MMA_INST_DESCEND4 (_C, 28,  4, _A[1], _B); \
        }

#define MMA_INST_2x8(_C, _A, _B) \
        { \
            MMA_INST_ASCEND8  (_C, 0,   4, _A[0], _B); \
            MMA_INST_DESCEND8 (_C, 60,  4, _A[1], _B); \
        }
...
#define MMA_INST_4x1(_C, _A, _B) \
        { \
            MMA_INST_ASCEND1  (_C, 0,   4, _A[0], _B); \
            MMA_INST_DESCEND1 (_C, 4,   4, _A[1], _B); \
            MMA_INST_ASCEND1  (_C, 8,   4, _A[2], _B); \
            MMA_INST_DESCEND1 (_C, 12,  4, _A[3], _B); \
        }

#define MMA_INST_4x2(_C, _A, _B) \
        { \
            MMA_INST_ASCEND2  (_C, 0,   4, _A[0], _B); \
            MMA_INST_DESCEND2 (_C, 20,  4, _A[2], _B); \
            MMA_INST_ASCEND2  (_C, 8,   4, _A[1], _B); \
            MMA_INST_DESCEND2 (_C, 28,  4, _A[3], _B); \
        }

#define MMA_INST_4x4(_C, _A, _B) \
        { \
            MMA_INST_ASCEND4  (_C, 0,   4, _A[0], _B); \
            MMA_INST_DESCEND4 (_C, 44,  4, _A[2], _B); \
            MMA_INST_ASCEND4  (_C, 16,   4, _A[1], _B); \
            MMA_INST_DESCEND4 (_C, 60,  4, _A[3], _B); \
        }

#define MMA_INST_4x8(_C, _A, _B) \
        { \
            MMA_INST_ASCEND8  (_C, 0,   4, _A[0], _B); \
            MMA_INST_DESCEND8 (_C, 92,  4, _A[2], _B); \
            MMA_INST_ASCEND8  (_C, 32,  4, _A[1], _B); \
            MMA_INST_DESCEND8 (_C, 124, 4, _A[3], _B); \
        }
...
#define MMA_INST_8x1(_C, _A, _B) \
        { \
            ...
            MMA_INST_DESCEND1 (_C, 12,  4, _A[3], _B); \
            \
            MMA_INST_ASCEND1  (_C, 16,  4, _A[4], _B); \
            MMA_INST_DESCEND1 (_C, 20,  4, _A[5], _B); \
            MMA_INST_ASCEND1  (_C, 24,  4, _A[6], _B); \
            MMA_INST_DESCEND1 (_C, 28,  4, _A[7], _B); \
        }

#define MMA_INST_8x2(_C, _A, _B) \
        { \
            MMA_INST_ASCEND2  (_C, 0,   4, _A[0], _B); \
            MMA_INST_DESCEND2 (_C, 36,  4, _A[4], _B); \
            MMA_INST_ASCEND2  (_C, 8,   4, _A[1], _B); \
            MMA_INST_DESCEND2 (_C, 44,  4, _A[5], _B); \
            \
            MMA_INST_ASCEND2  (_C, 16,  4, _A[2], _B); \
            MMA_INST_DESCEND2 (_C, 52,  4, _A[6], _B); \
            MMA_INST_ASCEND2  (_C, 24,  4, _A[3], _B); \
            MMA_INST_DESCEND2 (_C, 60,  4, _A[7], _B); \
        }

#define MMA_INST_8x4(_C, _A, _B) \
        { \
            MMA_INST_ASCEND4  (_C, 0,   4, _A[0], _B); \
            MMA_INST_DESCEND4 (_C, 100, 4, _A[4], _B); \
            MMA_INST_ASCEND4  (_C, 16,  4, _A[1], _B); \
            MMA_INST_DESCEND4 (_C, 108, 4, _A[5], _B); \
            \
            MMA_INST_ASCEND4  (_C, 32,  4, _A[2], _B); \
            MMA_INST_DESCEND4 (_C, 116, 4, _A[6], _B); \
            MMA_INST_ASCEND4  (_C, 48,  4, _A[3], _B); \
            MMA_INST_DESCEND4 (_C, 224, 4, _A[7], _B); \
        }
