...
const ppl::common::RetCode ConvCompiler::Compile(ir::Node* node, const OptKernelOptions& options) {
    ...
    if (algo_param.algo_name.find("Idxn") != std::string::npos) {
        ...
        Gene2spkKernel(source, algo_param.algo_name, algo_param.tiles.m_cta, algo_param.tiles.n_cta, algo_param.tiles.m_warp, algo_param.tiles.n_warp, algo_param.tiles.k_cta, algo_param.tiles.k_per_set, algo_param.splitk, algo_param.splitf, algo_param.tiles.buf, 0);
